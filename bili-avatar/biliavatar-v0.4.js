    ...
    <body>
        <div class="container">
            ...
            <div class="btn-wrapper">
                ...
                <div class="search-group">
                    ...
                    <select class="engine-selector" id="searchEngine">
                        <option value="google" title="Google 的智能图片识别工具，可识别物体、地点、文字等">Google Lens</option>
                        <option value="saucenao" title="专注于动漫、插画的反向图片搜索引擎">SauceNAO</option>
                        <option value="tineye" title="老牌反向图片搜索引擎，索引量大">TinEye</option>
                        <option value="iqdb" title="专注于二次元图片的搜索引擎">IQDB</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <script>
            ...
            function searchByUrl() {
                ...
                function googleSearchByImage(_url) {
                    if (_url) {
                ...
                function saucenaoSearchByImage(_url) {
                    if (_url) {
                        _url = encodeURIComponent(_url);
                        const saucenao_url = "https://saucenao.com/search.php?url=" + _url;
                        window.open(saucenao_url, "_blank");
                    }
                }

                function tineyeSearchByImage(_url) {
                    if (_url) {
                        _url = encodeURIComponent(_url);
                        const tineye_url = "https://tineye.com/search?url=" + _url;
                        window.open(tineye_url, "_blank");
                    }
                }

                function iqdbSearchByImage(_url) {
                    if (_url) {
                        _url = encodeURIComponent(_url);
                        const iqdb_url = "https://iqdb.org/?url=" + _url;
                        window.open(iqdb_url, "_blank");
                    }
                }
                
                switch(engine) {
                    case "google":
                        googleSearchByImage(_url);
                        break;
                    case "saucenao":
                        saucenaoSearchByImage(_url);
                        break;
                    case "tineye":
                        tineyeSearchByImage(_url);
                        break;
                    case "iqdb":
                        iqdbSearchByImage(_url);
                        break;
                    case "saucenao":
                    default:
                        googleSearchByImage(_url);
