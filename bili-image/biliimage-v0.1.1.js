...
// @author       SHYUF
// @include      /^https?:\/\/i\d\.hdslb\.com\/.*\.(?:jpg|png|jpeg|gif|bmp|webp)@.+\.(?:webp|avif)$/
// @include      /^https?:\/\/i\d\.hdslb\.com\/.*\.(?:jpg|png|jpeg|gif|bmp|webp)$/
...
(function() {
    ...
    function removeImageFormatSuffix() {
        var pattern = /^(.+\.(?:jpg|png|jpeg|gif|bmp|webp))@.+\.(?:webp|avif)$/i;
